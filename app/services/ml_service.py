...
#             logger.info(f"Features d'entrée: {features}")
#             logger.info(f"Shape du array: {features_array.shape}")
...
#             logger.info(f"Prédiction finale: {predicted_class} (confiance: {confidence:.3f})")
